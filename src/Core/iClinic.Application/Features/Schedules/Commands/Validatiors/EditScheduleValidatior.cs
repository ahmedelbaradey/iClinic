...
{
    public class EditScheduleValidatior : AbstractValidator<EditScheduleCommand>
    {
        #region Fileds
        ...
        public EditScheduleValidatior(IEmployeeScheduleService employeeScheduleService)
        {
