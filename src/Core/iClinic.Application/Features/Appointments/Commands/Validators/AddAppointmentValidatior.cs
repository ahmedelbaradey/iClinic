...
{
    public class AddAppointmentValidatior : AbstractValidator<AddAppointmentCommand>
    {
        ...
        public AddAppointmentValidatior(IPatientCaseService patientCaseService,IDoctorService doctorService, IAppointmentStatusService appointmentStatusService)
        {
